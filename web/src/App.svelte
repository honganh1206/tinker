...
<div
  theme="light"
  class="h-screen overflow-hidden grid grid-rows-[44px_1fr] grid-cols-[300px_1fr]"
>
  ...
  <main class="flex flex-col overflow-hidden bg-[var(--color-bg-primary)]">
    ...
    {:else}
      <div
        class="text-[var(--color-text-tertiary)] text-[var(--font-size-sm)] p-16 text-center font-[var(--font-mono)]"
      >
